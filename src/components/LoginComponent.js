...
function LoginComponent () {
    ...
    return(
        ...
        {isLoading && 
            ...
            {!isLoading && error ? 
                <div className="col-lg-12 justify-content-center entries p-4">

                    <article className="entry">

                    <h2 className="entry-content text-center">
                        <a href="blog-single.html">An error occured please check user name and password</a>
                    </h2>

                    </article>

                </div> : null }
                 {!isLoggedIn && !error ? <section className="sinner-page mt-5 align-items-center justify-content-center">
