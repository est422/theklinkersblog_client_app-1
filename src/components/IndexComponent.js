            ...
            <div className="row portfolio-container" data-aos="fade-up" data-aos-delay="200">
              ...
              <div className="col-lg-4 col-md-6 portfolio-item filter-app">
                ...
                <div className="portfolio-info">
                  <h4 className="text-center">Wegagen Bank HQ Project</h4>
                  {/* <p>App</p>
                  <a href="assets/images/team/img-1.jpg" data-gallery="portfolioGallery" className="portfolio-lightbox preview-link" title="App 1"><i className="bx bx-plus"></i></a>
              ...
              <div className="col-lg-4 col-md-6 portfolio-item filter-app">
                ...
                <div className="portfolio-info">
                  ...
                  {/* <p>App</p>
                  <a href="assets/images/team/portfolio-3.jpg" data-gallery="portfolioGallery" className="portfolio-lightbox preview-link" title="App 2"><i className="bx bx-plus"></i></a>
                  <a href="portfolio-details.html" className="details-link" title="More Details"><i className="bx bx-link"></i></a> */}
                </div>
              </div>
              ...
              <div className="col-lg-4 col-md-6 portfolio-item filter-card">
                ...
                <div className="portfolio-info">
                  ...
                  {/* <p>Card</p>
                  <a href="assets/images/team/portfolio-4.jpg" data-gallery="portfolioGallery" className="portfolio-lightbox preview-link" title="Card 2"><i className="bx bx-plus"></i></a>
                  <a href="portfolio-details.html" className="details-link" title="More Details"><i className="bx bx-link"></i></a> */}
                </div>
              </div>
